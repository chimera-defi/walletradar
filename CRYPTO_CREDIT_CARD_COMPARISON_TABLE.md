...
| **Binance Card** | 82 🟢 | Debit | Up to 8% | $0 | 0% | BNB | None | ⚠️ Verify | [binance.com/en/cards](https://www.binance.com/en/cards) | ✅ Active | Binance users | Debit card |
| **Wirex Card** | 80 🟢 | Debit | Up to 8% | $0 | 0% | WXT | None | ⚠️ Verify | [wirexapp.com/card](https://wirexapp.com/card) | ✅ Active | Multi-crypto | Debit card |
| **Fold Card** | 78 🟢 | Debit | Up to 5% | $0 | 0% | BTC | None | ❌ | [foldapp.com](https://foldapp.com) | ✅ Active | Bitcoin rewards | Bitcoin rewards only |
...
**Human Suggestions:** Accounts for real-world user experiences, company reputation, and practical considerations:
- **Crypto.com Visa: -20 points** - Poor user experiences, customer service issues, staking lock-up periods, company reputation concerns
- **404 errors: -5 points** - Cards with website access issues (Swissborg, Uphold, CoinJar)
...
#### Coinbase Card
- **Type:** Debit card
- **Cash Back:** 1% base, up to 4% with Coinbase One subscription
...
- **Type:** Debit card (prepaid)
- **Cash Back:** Tiered 0.5% to 8% based on CRO stake
  - Midnight Blue: 0.5% (no stake)
  - Ruby Steel: 2% ($400 CRO stake)
  - Royal Indigo/Jade Green: 3% ($4,000 CRO stake)
  - Frosted Rose Gold/Icy White: 5% ($40,000 CRO stake)
...
#### Gemini Credit Card
- **Type:** Credit card
- **Cash Back:** 1% base, up to 3% in specific categories
- **Rewards:** BTC or ETH (user choice)
- **Annual Fee:** $0
- **Foreign Transaction Fee:** 0%
- **Staking Required:** None
- **Business Support:** ❌ Personal only
...
#### Nexo Card
- **Type:** Credit card (crypto-backed credit line)
- **Cash Back:** 0-2% cashback
- **Rewards:** NEXO token (up to 2% additional)
- **Annual Fee:** $0
- **Foreign Transaction Fee:** 0%
...
#### Binance Card
- **Type:** Debit card
- **Cash Back:** Up to 8% (varies by BNB holdings)
- **Rewards:** BNB
- **Annual Fee:** $0
- **Foreign Transaction Fee:** 0%
...
#### Wirex Card
- **Type:** Debit card
- **Cash Back:** Up to 8% (Cryptoback™ rewards)
- **Rewards:** WXT token
- **Annual Fee:** $0
- **Foreign Transaction Fee:** 0%
- **Staking Required:** None
...
- **Reason:** BlockFi filed for bankruptcy
- **Previous Terms:** 1.5% cash back in BTC, $0 annual fee

#### MCO Card (Crypto.com Legacy)
- **Status:** ❌ Discontinued
- **Reason:** Replaced by CRO-based card
- **Previous Terms:** Tiered rewards based on MCO stake
...
5. **Binance Card** - 82 🟢 - Up to 8% BNB rewards (Global)
6. **Wirex Card** - 80 🟢 - Up to 8% WXT rewards (Global)
7. **Fold Card** - 78 🟢 - Up to 5% Bitcoin rewards (US)
8. **Gemini Credit Card** - 75 🟢 - 1-3% credit card (US)

### Best Cash Back Rates
1. **Mode Card** - Up to 10% (Bitcoin)
2. **Crypto.com Obsidian** - 8% (with $400k+ CRO stake) ⚠️ Score: 59 🟡 (UX penalty: -20 pts)
3. **Binance Card** - Up to 8% (with BNB holdings)
4. **Wirex Card** - Up to 8% (WXT rewards)
5. **Fold Card** - Up to 5% (Bitcoin)

### No Annual Fee Cards
- Most crypto cards have $0 annual fees
...
- ⚠️ **Binance Card** - Score: 82 🟢 - Verify business account availability
- ⚠️ **Wirex Card** - Score: 80 🟢 - Verify business account availability
- ⚠️ **BitPay Card** - Score: 52 🟡 - Verify business account availability
- ⚠️ **Uphold Card** - Score: 70 🟡 - Verify business account availability (404 error)
...
- All information should be verified on official card websites
- Terms and conditions change frequently
- Availability varies by jurisdiction
- Credit cards require credit checks (Gemini, Nexo)
- Debit cards may require account funding

⚠️ **Regulatory Considerations:**
- Crypto card regulations vary by country
- Some cards may not be available in all jurisdictions
- Tax implications vary by country

⚠️ **Staking Requirements:**
- Some cards require staking tokens (Crypto.com CRO)
- Staking may have lock-up periods
- Token values fluctuate (staking risk)
