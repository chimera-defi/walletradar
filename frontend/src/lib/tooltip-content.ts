...
export const softwareWalletTooltips = {
  ...
  headers: {
    ...
    github: 'Link to main repository. "Private" means closed source.',
    ...
    devices: 'Device support: 📱 Mobile, 🌐 Browser Extension, 💻 Desktop App, 🔗 Web App, ⚡ Proxy',
    testnets: 'Testnet support: ✅ custom chains/testnets, ❌ none',
    ...
    api: 'API openness: ✅ open source + self-hostable, 🌐 public APIs, ⚠️ partial/provider, ❌ closed',
    audits: 'Security audits: ✅ recent (2023+), ⚠️ old/issues, 🐛 bug bounty, ❓ none/private',
    funding: 'Funding strength: 🟢 sustainable, 🟡 VC-dependent, 🔴 risky/unknown',
    txSim: 'Transaction simulation: ✅ built-in, ⚠️ plugin/limited, ❌ none',
    scam: 'Scam/phishing alerts: ✅ built-in, ⚠️ basic, ❌ none',
...
export const hardwareWalletTooltips = {
  headers: {
    ...
    display: 'Display type: Touch Color, Mono OLED, Color LCD, E-Ink, or None (NFC card)',
