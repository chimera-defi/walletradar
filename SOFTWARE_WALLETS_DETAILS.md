...
> **Source of truth note:** Current `Score` and `Rec` values are generated from the visible columns in [SOFTWARE_WALLETS.md](./SOFTWARE_WALLETS.md) via `scripts/sync_table_scores.js` (`2026-04-visible-columns-v4`). If a long-form section below mentions older numeric scores, trust the main comparison table.
...
> **Current generated snapshot:** Rabby (84, Development, 🟢), MetaMask (77, Compatibility, 🟢), Safe (77, Treasury/DAO, ⚪), and Brave (75, Brave users, 🟢). Regenerated from [SOFTWARE_WALLETS.md](./SOFTWARE_WALLETS.md) by `scripts/sync_table_scores.js` using methodology `2026-04-visible-columns-v4`.
