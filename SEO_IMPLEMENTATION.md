...
**File:** `/home/user/walletradar; s{}{}src/lib/seo.ts`
...
**File:** `/home/user/walletradarsrc/app/wallets/[type]/[id]/page.tsx`
...
**Files Modified:**
1. `/home/user/walletradar/HARDWARE_WALLETS.md` (+45 lines)
2. `/home/user/walletradar/SOFTWARE_WALLETS.md` (+43 lines)
3. `/home/user/walletradar/CRYPTO_CARDS.md` (+43 lines)
4. `/home/user/walletradar/RAMPS.md` (+43 lines)
...
### 4. Blog/Article System for SEO Content (`articles/`, `app; s{cd /home/user/walletradar/frontend}{cd /home/user/walletradar/frontend}`)
...
1. **Article Data Layer** (`lib/articles.ts`) - 120 lines
   ...
   - `getRelatedArticles(slug)` - Finds similar articles by tags
...
```bash
# Build and validate
cd /home/user/walletradar/frontend
npm install
npm run build
npm run lint
npm run type-check
...
**SEO Core:**
- `/walletssrc/lib/seo.ts` - All schema generators
- `/walletssrc/lib/articles.ts` - Article data layer (NEW)
- `/walletssrc/app/layout.tsx` - Organization/WebSite schema
- `/walletssrc/app/page.tsx` - Homepage FAQs + TopPicks
- `/walletssrc/app/docs/[slug]/page.tsx` - Doc page schemas
- `/walletssrc/app/wallets/[type]/[id]/page.tsx` - Wallet profile schemas
- `/walletssrc/app/articles/[slug]/page.tsx` - Article page template (NEW)
- `/walletssrc/app/articles/page.tsx` - Article listing page (NEW)
...
**Config:**
- `/walletspublic/robots.txt` - Crawl directives
- `/walletssrc/app/sitemap.ts` - Dynamic sitemap (includes articles)
