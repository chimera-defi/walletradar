...
- **Provider:** Card issuer/exchange (cards from same provider share scoring handicaps)
...
## Cards by Provider/Exchange Group
...
Independent card providers, not tied to major exchanges.
...
Designed primarily for business/corporate use cases.
...
**Baanx** provides white-label crypto card infrastructure. Cards powered by Baanx share underlying technology:
- **1inch Card** - Baanx + Mastercard partnership
- **Tezos Card** (coming) - Non-custodial on-chain card
- Various USDC stablecoin cards with Visa
...
- **Provider Groupings:** Cards from the same exchange/provider share infrastructure risks and scoring handicaps

---

## Provider/Exchange Scoring Handicaps

To ensure consistent scoring, cards from the same category receive identical handicaps:
